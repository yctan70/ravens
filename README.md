...
```shell
python ravens/demos.py --assets_root=./ravens/environments/assets/ --disp=True --task=depalletizing --mode=train --n=10
python ravens/demos.py --assets_root=./ravens/environments/assets/ --disp=True --task=depalletizing --mode=test --n=100
```
...
```shell
python ravens/plot.py --disp=True --task=depalletizing --agent=transporter --n_demos=10
```
